# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-12-19 11:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency=b'USD', max_digits=14)),
                ('keywords', models.TextField(blank=True)),
                ('is_active', models.BooleanField(default=True)),
                ('created_on', models.DateTimeField(default=datetime.datetime.now)),
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='title', unique_with=['created_on__month'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authDomain', models.CharField(max_length=100)),
                ('databaseURL', models.CharField(max_length=100)),
                ('projectId', models.CharField(max_length=100)),
                ('storageBucket', models.CharField(max_length=100)),
                ('messagingSenderId', models.CharField(max_length=100)),
                ('created_on', models.DateTimeField(default=datetime.datetime.now)),
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='eventLiveCommentConf', to='Event.EventLive')),
            ],
            options={
                'verbose_name': 'Event Live Comment Configuration',
                'verbose_name_plural': 'Event Live Comment Configurations',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('primary_server', models.CharField(max_length=250)),
                ('host_port', models.PositiveIntegerField()),
                ('application', models.CharField(max_length=100)),
                ('stream_name', models.CharField(max_length=100)),
                ('disable_authentication', models.BooleanField(default=False)),
                ...
                ('hls', models.CharField(max_length=250)),
                ('player_embedded_code_web', models.CharField(max_length=100)),
                ('created_on', models.DateTimeField(default=datetime.datetime.now)),
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='eventLiveStreamConf', to='Event.EventLive')),
            ],
            options={
                'verbose_name': 'Event Live Stream Configuration',
                'verbose_name_plural': 'Event Live Stream Configurations',
            },
        ),
    ]
